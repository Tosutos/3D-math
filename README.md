...
- `unfold`: 아랫면의 4개 모서리 중 하나를 선택하고, 해당 모서리 옆 3D 핸들바를 드래그해 선택 모서리 기준으로 종이처럼 펴지는 과정 보기
...
- 펼침 중 어느 모서리가 힌지이고 어느 모서리가 잘린 선인지 색으로 더 명확하게 표시
- 현재 아랫면 4개 모서리 중심인 전개 선택을 전체 12개 모서리 선택으로 확장
